...
import br.com.prog2.sh.controller.HospedagemController;
...
public class FrmHospedagem extends JFrame {
	...
	public FrmHospedagem() {
		...
		tblConsulta.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String codHospedagm = tblConsulta.getValueAt(linha, 1).toString();
				String estado = tblConsulta.getValueAt(linha, 2).toString();
				String dataInicio = tblConsulta.getValueAt(linha, 3).toString();
				String dataFim = tblConsulta.getValueAt(linha, 4).toString();
				String qtdPessoas = tblConsulta.getValueAt(linha, 5).toString();
				String desconto = tblConsulta.getValueAt(linha, 6).toString();
				String valorFinal = tblConsulta.getValueAt(linha, 7).toString();
				...
				for (Chale c : listaChale) {
					if (c.getCodChale().equals(tblConsulta.getValueAt(linha, 0).toString())) {
		...
		tblConsulta.setModel(new DefaultTableModel(new Object[][] {}, new String[] { "C\u00F3digoChale", "C\u00F3digoHospedagem",
				"Estado", "Data de inicio", "Data de Fim\u00ED", "Qtd de pessoas", "Desconto", "ValorFinal" }) {
		...
		btnInserir.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent arg0) {
				...
				h.setCodHospedagem(txtCodHospedagem.getText());
				h.setCodChale(listaChale.get(pos).getCodChale());
				...
				int[] dataFormatada1 = Util.formatarDataDeGuiParaLocalDate(txtDataFim.getText());
				...
				h.setValorFinal(Double.parseDouble(txtValorFinal.getText()));
				if (hc.pesquisarPorHospedagens(h.getCodHospedagem()) != null) {
		...
		btnExcluir.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent arg0) {
				...
				int i = JOptionPane.showOptionDialog(null,
						"Deseja excluir essa Hospedagem nº: " + txtCodHospedagem.getText() + "?", "Exclusão",
				...
				.addGroup(gl_panel.createSequentialGroup().addContainerGap()
						.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING, false).addGroup(gl_panel
								.createSequentialGroup().addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_panel.createSequentialGroup().addComponent(lblCodigo)
												.addPreferredGap(ComponentPlacement.RELATED).addComponent(txtCodHospedagem))
										.addGroup(gl_panel.createSequentialGroup().addComponent(lblDataDeSaida)
						...
						.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel.createSequentialGroup().addGap(18)
										.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
												.addComponent(lblCodigo).addComponent(txtCodHospedagem, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
	...
	public void mostrarDados() {
		...
		for (Hospedagem h : listaHosp) {
			...
			tblConsulta.setValueAt(h.getCodChale(), i, 0);
			tblConsulta.setValueAt(h.getCodHospedagem(), i, 1);
